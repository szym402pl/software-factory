...
Then use Grep and Glob tools to walk the codebase directly — no Explore subagent. Don't follow rigid heuristics — explore organically and note where you experience friction:
